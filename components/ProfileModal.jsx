...
export default function ProfileModal({ isOpen, firstName, setFirstName, lastName, setLastName, email, setEmail, loading, message, onSubmit, onClose }) {
    ...
    <div className="auth-modal-overlay" onClick={onClose}>
      <div className="auth-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="auth-modal-body">
          ...
          <input
            className={`auth-input text-[#1e293b] ${
                email && !isValidEmail(email) ? "input-error" : ""
            }`}
            value={email}
